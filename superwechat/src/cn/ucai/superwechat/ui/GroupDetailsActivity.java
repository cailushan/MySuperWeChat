...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
    ...
    private void exitGrop() {
        ...
        NetDao.deleteGroupMember(GroupDetailsActivity.this, groupId, EMClient.getInstance().getCurrentUser(), new OnCompleteListener<String>() {
            @Override
    ...
    private void deleteGrop() {
        ...
        NetDao.deleteGroup(GroupDetailsActivity.this, groupId, new OnCompleteListener<String>() {
            @Override
            public void onSuccess(String result) {
...
//				button.setCompoundDrawables(null, avatar, null, null);
                ...
                button.setOnClickListener(new OnClickListener() {
                    ...
                    protected void deleteMembersFromGroup(final String username) {
                        ...
                        deleteDialog.show();
                        NetDao.deleteGroupMember(getContext(), groupId, username, new OnCompleteListener<String>() {
                            @Override
                            public void onSuccess(String s) {
