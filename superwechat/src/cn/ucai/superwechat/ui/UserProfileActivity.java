...
public class UserProfileActivity extends BaseActivity implements OnClickListener {
    ...
    private void updateRemoteNick(final String nickName) {
        ...
        NetDao.updateUserNick(this, EMClient.getInstance().getCurrentUser(), nickName, new OnCompleteListener<String>() {
                ...
                if (s != null) {
                    ...
                    if (result != null) {
                        if (result.isRetMsg()) {
                            User user = (User) result.getRetData();
                            if (user != null) {
                                L.e("updateRemoteNick", "user=" + user);
            ...
            @Override
            public void onError(String error) {
                L.e("updateRemoteNick", "error=" + error);
                dialog.dismiss();
                CommonUtils.showShortToast(R.string.toast_updatenick_fail);
            }
        });
...
//        }).start();
    ...
    private void uploadAppUserAvatar(Intent picdata) {
        ...
        dialog = ProgressDialog.show(this, getString(R.string.dl_update_photo), getString(R.string.dl_waiting));
        NetDao.updateUserAvatar(this, EMClient.getInstance().getCurrentUser(), file,
